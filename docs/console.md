...
> This page contains information about the CLI support of SlotBuddy.

### Introduction

Starting from v1.4.0 SlotBuddy has introduced CLI support, providing a set of useful utilities to use with your installation. 
...
This command will perform a CLI installation of SlotBuddy. 
