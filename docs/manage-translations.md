...
Follow these steps in order to add or adjust your translations and modify the message of the user interface of SlotBuddy. If you want contribute to the translation process of SlotBuddy please read the [Get Involved](https://github.com/ppa/SlotBuddy/wiki/Get-Involved!) wiki page for more information. Please share your translations with the user community. 
