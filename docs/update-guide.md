...
This page will guide you through the update procedure of your SlotBuddy installation. You will need to follow the steps below in order to have successful results.
...
###### Step 1: Update your SlotBuddy files
...
Open your browser to the SlotBuddy installation URL, login to the backend and type in the browser address the following URL to complete the database upgrade: `https://url/to/slotbuddy/folder/index.php/backend/update`
