...
<header>
    <div class="container">
        <h1 class="page-title">SlotBuddy Installation</h1>
    </div>
</header>

<div class="content container h-100">
    <div class="welcome">
        <h3>Welcome to the SlotBuddy installation page.</h3>
        <p>
    ...
    <div class="mb-2">
        <h3>License</h3>
        SlotBuddy is licensed under the <span class="badge bg-secondary">GPL-3.0 license</span>. By using the
        code
