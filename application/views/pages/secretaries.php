...
<div class="backend-page" id="secretaries-page">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6" id="secretaries">
        <div id="filter-secretaries" class="filter-records lg:col-span-1">
            <div class="sb-card">
            ...
            <div class="sb-card p-6">
                <div class="flex flex-wrap items-center gap-2 mb-4">
                    <div class="add-edit-delete-group inline-flex rounded-md shadow-sm">
                        <button id="add-secretary" class="sb-btn-primary">
                            <i class="fas fa-plus-square mr-2"></i>
                            <?= lang('add') ?>
                        </button>
                        <button id="edit-secretary" class="sb-btn-secondary" disabled="disabled">
                            <i class="fas fa-edit mr-2"></i>
                            <?= lang('edit') ?>
                        </button>
                        <button id="delete-secretary" class="sb-btn-secondary" disabled="disabled">
                    ...
                    <div class="save-cancel-group" style="display:none;">
                        <button id="save-secretary" class="sb-btn-primary">
                            <i class="fas fa-check-square mr-2"></i>
                            <?= lang('save') ?>
                        </button>
                        <button id="cancel-secretary" class="sb-btn-secondary">
                            <?= lang('cancel') ?>
                        </button>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="settings">
                        ...
                        <div id="secretary-providers" class="sb-card p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                            <!-- JS -->
                        </div>
