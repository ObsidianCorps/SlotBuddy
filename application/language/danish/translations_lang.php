...
$lang['about_app_info'] = 'SlotBuddy er et specielfremstillet internet applikation som giver mulighed for kunderne at booke bestillinger med dig via internettet. Endvidere leverandørens evne til at synkronisere dine data med Google kalender, så du kan bruge dem med andre tjenester.';
$lang['current_version'] = 'Nuværende version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'Hvis du støder på nogen problemer når du bruger SlotBuddy kan du søge i officiel Google gruppe for svar. Du må også lave en levering i google kode side for at hjælpe opstående proces.';
...
$lang['license'] = 'Licens';
$lang['about_app_license'] = 'SlotBuddy er autoriseret til GPLv3 lisens. Ved at bruge koden SlotBuddy i hvert fald, du giver samtykke til periodens beskrivelse i det følgende url.';
...
$lang['ea_update_success'] = 'SlotBuddy er blevet opdateret.';
...
$lang['api_token_hint'] = 'Indstil en hemmelig token for at aktivere tokenbaseret autentificering af SlotBuddy API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API giver dig mulighed for at interagere med alle SlotBuddy-data via HTTP-protokollen og de tilgængelige API-endepunkter og oprette dine egne integrationer.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Denne integration giver dig mulighed for at oprette forbindelse til en eksisterende LDAP-server og automatisk importere brugere til SlotBuddy og lade dem SSO med deres katalogadgangskode (brugernavnet skal matche).';
$lang['host'] = 'Vært';
$lang['port'] = 'Port';
