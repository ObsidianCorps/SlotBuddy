...
$lang['about_app_info'] = 'SlotBuddyは、カスタマイズ可能な予約受付ウエッブアップリケーションです。さら、Googleカレンダーとの連携ができるので、このシステムのスケジュールを他のシステムのスケジュールとまとめてみることができます。';
$lang['current_version'] = 'バージョン番号';
$lang['support'] = 'サポート';
$lang['about_app_support'] = ' SlotBuddy を利用する上で もし何か 問題がありましたら 、是非　公式 Google Groupを検索して 解決方法を見つけてください。もしかしたら 開発をさらに良いものにするために 新しい課題を Google Code に 登録することもできます。';
...
$lang['license'] = 'ライセンス';
$lang['about_app_license'] = 'SlotBuddy は　GPLv3 ライセンス に従います。 SlotBuddy　のプログラムコードを使用するということは、あるあらゆる面で 次のURLのサイトにある条件に同意したこととなります。:';
...
$lang['ea_update_success'] = 'SlotBuddy の　アップデートが成功しました。';
...
$lang['api_token_hint'] = 'SlotBuddy APIのトークンベースの認証を有効にするために、秘密のトークンを設定します。';
...
$lang['api'] = 'API';
$lang['api_info'] = 'APIを使用すると、HTTPプロトコルおよび利用可能なAPIエンドポイントを介してすべてのSlotBuddyデータと対話し、独自の統合を作成できます。';
...
$lang['connect'] = '接続';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'この統合により、既存のLDAPサーバーに接続してユーザーを自動的にSlotBuddyにインポートし、ディレクトリパスワードでSSOできます（ユーザー名は一致する必要があります）。';
$lang['host'] = 'ホスト';
$lang['port'] = 'ポート';
$lang['user_dn'] = 'ユーザーDN';
$lang['base_dn'] = 'ベースDN';
