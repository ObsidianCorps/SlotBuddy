...
$lang['about_app_support'] = 'Ako naiđete na bilo kakve probleme kada koristite SlotBuddy, možete pretražiti zvaničnu Google grupu za odgovore. Možda ćete također morati kreirati novi problem na stranici Google Code kako biste pomogli u razvoju.';
...
$lang['about_app_license'] = 'Easy! Sastanci su licencirani pod GPLv3 licencom. Korištenjem koda SlotBuddy na bilo koji način pristajete na uslove opisane na sljedećem URL-u:';
...
$lang['api_token_hint'] = 'Postavite tajni token da biste omogućili autentifikaciju baziranu na tokenu za SlotBuddy API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API vam omogućava da komunicirate sa svim podacima SlotBuddy putem HTTP protokola i dostupnih API krajnjih tačaka i kreirate sopstvene integracije.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Ova integracija vam omogućava da se povežete na postojeći LDAP server i automatski uvezete korisnike u SlotBuddy i dozvolite im da SSO sa svojom lozinkom direktorijuma (korisničko ime mora da se podudara).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
