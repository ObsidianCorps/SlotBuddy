...
$lang['about_app_support'] = 'Ако срещнете затруднения с SlotBuddy, можете да претърсите официалната гугъл група за отговори и потенциални решения. Възможно е да се наложи да създадете нов запис за проблем в страницата за кодът, за да подпомогнете разработчиците.';
...
$lang['api_token_hint'] = 'Задайте таен токен, за да активирате удостоверяването на API на SlotBuddy на базата на токен.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API ви позволява да взаимодействате с всички данни на SlotBuddy чрез HTTP протокола и наличните API крайни точки, за да създадете собствени интеграции.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Тази интеграция ви позволява да се свържете с LDAP сървър и автоматично да импортирате потребители в SlotBuddy и да им позволите SSO с тяхната парола от директорията (потребителското име трябва да съвпада).';
$lang['host'] = 'Хост';
$lang['port'] = 'Порт';
