...
$lang['about_app_info'] = 'SlotBuddy er en svært tilpassbar webapplikasjon som lar kundene dine bestille avtaler med deg via nettet. Videre gir den muligheten til å synkronisere dataene dine med Google Kalender, slik at du kan bruke dem med andre tjenester.';
$lang['current_version'] = 'Nåværende Versjon';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'Hvis du støter på problemer når du bruker SlotBuddy, kan du søke i det offisielle Google-gruppen etter svar. Du kan også trenge å opprette en ny sak på Google Code-siden for å hjelpe utviklingen fremover.';
...
$lang['license'] = 'Lisens';
$lang['about_app_license'] = 'SlotBuddy er lisensiert under GPLv3-lisensen. Ved å bruke koden til SlotBuddy på noen måte godtar du vilkårene beskrevet i følgende URL:';
...
$lang['ea_update_success'] = 'SlotBuddy har blitt oppdatert.';
...
$lang['api_token_hint'] = 'Angi et hemmelig token for å aktivere tokenbasert autentisering av SlotBuddy API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API gjør det mulig for deg å samhandle med alle SlotBuddy-data via HTTP-protokollen og de tilgjengelige API-endepunktene og opprette dine egne integrasjoner.';
