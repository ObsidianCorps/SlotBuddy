...
$lang['about_app'] = 'Σχετικά με το SlotBuddy';
...
$lang['about_app_info'] = 'Το SlotBuddy είναι μια εξαιρετικά προσαρμόσιμη διαδικτυακή εφαρμογή η οποία επιτρέπει στους πελάτες σας να κλείνουν ραντεβού με εσάς μέσω του διαδικτύου. Επιπλέον παρέχει την δυνατότητα να συγχρονίσετε τα δεδομένα σας με το Google Calendar έτσι ώστε να μπορέσετε να τα χρησιμοποιήσετε με άλλες υπηρεσίες.';
$lang['current_version'] = 'Τρέχουσα Έκδοση';
$lang['support'] = 'Υποστήριξη';
$lang['about_app_support'] = 'Αν αντιμετωπίσετε προβλήματα κατά την χρήση του SlotBuddy μπορείτε να ψάξετε το επίσημο Google Group για απαντήσεις. Μπορείτε επίσης να δημιουργήσετε ένα νέο θέμα στην σελίδα Google Code έτσι ώστε να βοηθήσετε την πρόοδο της ανάπτυξης.';
...
$lang['about_app_license'] = 'Το SlotBuddy έχει αδειοδοτηθεί υπό την άδεια χρήσης GPLv3. Χρησιμοποιώντας τον κώδικα του Easy!Appointents με οποιονδήποτε τρόπο συμφωνείτε με τους όρους που περιγράφονται στον ακόλουθο σύνδεσμο:';
...
$lang['ea_update_success'] = 'Το SlotBuddy ενημερώθηκε με επιτυχία.';
...
$lang['api_token_hint'] = 'Καταχωρήστε εναν μυστικό κωδικό για να μπορέσετε να ενεργοποιήσετε την token-based πιστοποίηση του SlotBuddy API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'Το API σας επιτρέπει να αλληλεπιδράτε με όλα τα δεδομένα του SlotBuddy μέσω του πρωτοκόλλου HTTP και των διαθέσιμων σημείων τερματισμού API και να δημιουργείτε τις δικές σας ενσωματώσεις.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Αυτή η ενσωμάτωση σας επιτρέπει να συνδεθείτε σε έναν υπάρχοντα διακομιστή LDAP και να εισάγετε αυτόματα τους χρήστες στο SlotBuddy και να τους επιτρέπετε να κάνουν SSO με τον κωδικό πρόσβασης του καταλόγου τους (το όνομα χρήστη πρέπει να ταιριάζει).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
