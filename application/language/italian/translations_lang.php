...
$lang['about_app'] = 'Info su SlotBuddy';
...
$lang['about_app_info'] = 'SlotBuddy è un\'applicazione web estremamente personalizzabile che permette ai tuoi clienti di prenotare appuntamenti con te attraverso il web. Inoltre, fornisce la possibilità di sincronizzare i tuoi dati con Google Calendar in modo da poterli usare in altri servizi.';
$lang['current_version'] = 'Versione corrente';
$lang['support'] = 'Supporto';
$lang['about_app_support'] = 'Se incontri un problema quando utilizzi SlotBuddy puoi cercare sul Gruppo Google ufficiale per le risposte. Potresti anche aver bisogno di creare una nuova segnalazione sulla pagina Google Code al fine di aiutarci negli sviluppi futuri.';
...
$lang['about_app_license'] = 'SlotBuddy è distributo sotto licenza GPLv3. Usando il codice di SlotBuddy stai accettando i termini e le condizioni descritte al seguente URL:';
...
$lang['ea_update_success'] = 'SlotBuddy è stato aggiornato con successo.';
...
$lang['api_token_hint'] = 'Imposta un token segreto per abilitare l\'autenticazione basata su token nelle API di SlotBuddy.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'Le API ti permettono di interagire con tutti i dati di SlotBuddy tramite il protocollo HTTP e gli endpoint API disponibili e creare le tue integrazioni.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Questa integrazione ti consente di connetterti a un server LDAP esistente e importare automaticamente gli utenti in SlotBuddy e di consentire loro l\'SSO con la loro password di directory (il nome utente deve corrispondere).';
$lang['host'] = 'Host';
$lang['port'] = 'Porta';
