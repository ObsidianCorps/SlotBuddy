...
$lang['about_app_info'] = 'SlotBuddy je veoma prilagodljiva veb-aplikacija koja omogućava Vašim korisnicima da zakazuju termine, a Vama da njima upravljate. Uz to, omogućava istovremenu povezanost Vaših podataka sa Google kalendarom koje možete onda koristiti na ostalim servisima.';
$lang['current_version'] = 'Trenutna verzija';
$lang['support'] = 'Podrška';
$lang['about_app_support'] = 'Ako imate bilo kakvih problema u radu sa aplikacijom SlotBuddy, odgovore možete potražiti na službenoj stranici Google Group. Možete osmisliti i novu verziju aplikacije na Google Code stranici u svrhu razvoja aplikacije.';
...
$lang['about_app_license'] = 'SlotBuddy aplikacija je licencirana pod GPLv3 licencom. Koristeći SlotBuddy na bilo koji način, slažete se sa uslovima korištenja koji su dati na sledećoj adresi:';
...
$lang['ea_update_success'] = 'SlotBuddy je uspešno ažuriran!';
...
$lang['api_token_hint'] = 'Postavite tajni token kako biste omogućili pristup SlotBuddy API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API vam omogućavaju da komunicirate sa svim podacima SlotBuddy putem HTTP protokola i dostupnih API krajnjih tačaka i kreirate svoje integracije.';
...
$lang['connect'] = 'Poveži';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Ova integracija vam omogućava da se povežete sa postojećim LDAP serverom i automatski uvezete korisnike u SlotBuddy i omogućite im SSO sa njihovom lozinkom iz direktorijuma (korisničko ime mora odgovarati).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
