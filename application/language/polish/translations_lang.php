...
$lang['about_app_info'] = 'SlotBuddy jest aplikacją webową wysoce przystosowywalną do potrzeb klienta. Co więcej pozwala na synchronizację z Kalendarzem Google.';
...
$lang['about_app_license'] = 'SlotBuddy posiada licencję GPLv3. Używaj zgodnie z warunkami opisanymi tu:';
...
$lang['api_token_hint'] = 'Ustaw tajny token, aby włączyć uwierzytelnianie oparte na tokenie w API SlotBuddy.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API umożliwia interakcję ze wszystkimi danymi SlotBuddy za pomocą protokołu HTTP oraz dostępnych punktów końcowych API i tworzenie własnych integracji.';
...
$lang['connect'] = 'Połącz';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Ta integracja umożliwia połączenie z istniejącym serwerem LDAP i automatyczne importowanie użytkowników do SlotBuddy oraz umożliwienie im logowania się za pomocą hasła z katalogu (nazwa użytkownika musi się zgadzać).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
