...
$lang['about_app'] = 'Tietoja SlotBuddy:sta';
...
$lang['about_app_info'] = 'SlotBuddy on web-sovellus jonka avulla asiakkaasi voivat varata aikoja netissä. Lisäominaisuutena on mahdollisuus synkronoida tapaamiset Google-kalenteriin, jolloin varaustietojen käyttö muissa palveluissa on helppoa.';
$lang['current_version'] = 'Tämänhetkinen versio';
$lang['support'] = 'Tuki';
$lang['about_app_support'] = 'Jos kohtaat ongelmia SlotBuddyin käytössä voit etsiä tietoa virallisesta Google-ryhmästä. Myös GitHub sivuston kautta voit olla mukana kehityksessä.';
...
$lang['about_app_license'] = 'SlotBuddy on GPLv3 lisensoitu. Käyttämällä SlotBuddyia palvelutuotannossa tai muilla lisenssissä mainituilla tavoilla suostut linkissä oleviin lisenssiehtoihin:';
...
$lang['ea_update_success'] = 'SlotBuddy päivitettiin onnistuneesti.';
...
$lang['api_token_hint'] = 'Aseta secret token aktivoidaksesi token-pohjaisen autentikoinnin SlotBuddy API:lle.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'Tämä mahdollistaa kaiken SlotBuddy -datan käsittelyn HTTP-protokollan ja API-rajapinnan kautta. Tällä voit luoda omia integraatioita järjestelmään.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Tämä integrointi mahdollistaa käyttäjien yhdistämisen olemassa olevaan LDAP-palvelimeen. Käyttäjät tuodaan automaattisesti SlotBuddy:iin, jolloin he voivat kirjautua AD-tunnuksillaan (käyttäjänimen tulee olla sama).';
$lang['host'] = 'Isäntä';
$lang['port'] = 'Portti';
