...
$lang['about_app_info'] = 'SlotBuddy je zelo prilagodljiva spletna aplikacija, ki vašim strankam omogoča, da rezervirajo sestanke pri vas prek spleta. Poleg tega ponuja možnost sinhronizacije vaših podatkov z Google Koledarjem, tako da jih lahko uporabljate z drugimi storitvami.';
$lang['current_version'] = 'Trenutna različica';
$lang['support'] = 'Podpora';
$lang['about_app_support'] = 'Če naletite na težave pri uporabi SlotBuddy, lahko poiščete odgovore v uradni Googlovi skupini. Morda boste morali ustvariti tudi novo številko na strani Google Code, da bi pomagali pri napredovanju razvoja.';
...
$lang['about_app_license'] = 'SlotBuddy je licenciran pod licenco GPLv3. Z uporabo kode SlotBuddy na kakršen koli način soglašate s pogoji, opisanimi na naslednjem url-ju:';
...
$lang['ea_update_success'] = 'SlotBuddy je bil uspešno posodobljen.';
...
$lang['api_token_hint'] = 'Nastavite skrivni žeton, da omogočite avtentikacijo SlotBuddy API na podlagi žetonov.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API vam omogoča interakcijo z vsemi podatki SlotBuddy prek protokola HTTP in razpoložljivih končnih točk API ter ustvarjanje lastnih integracij.';
...
$lang['connect'] = 'Poveži';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Ta integracija vam omogoča, da se povežete z obstoječim strežnikom LDAP in samodejno uvozite uporabnike v SlotBuddy ter jim omogočite SSO z njihovim geslom imenika (uporabniško ime se mora ujemati).';
$lang['host'] = 'Gostitelj';
$lang['port'] = 'Vrata';
