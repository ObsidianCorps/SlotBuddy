...
$lang['about_app'] = 'Rreth SlotBuddy';
...
$lang['about_app_info'] = 'SlotBuddy është një aplikacion web i personalizueshëm që lejon klientët tuaj të rezervojnë takime me ju nëpërmjet internetit. Për më tepër, ofron mundësinë për të sinkronizuar të dhënat tuaja me Google Calendar, në mënyrë që t\'i përdorni me shërbime të tjera.';
$lang['current_version'] = 'Versioni Aktual';
$lang['support'] = 'Mbështetje';
$lang['about_app_support'] = 'Nëse hasni ndonjë problem gjatë përdorimit të SlotBuddy, mund të kërkoni në grupin zyrtar të Google për përgjigje. Ju gjithashtu mund të krijoni një çështje të re në faqen e Google Code për të ndihmuar progresin e zhvillimit.';
...
$lang['about_app_license'] = 'SlotBuddy është i licencuar nën licencën GPLv3. Duke përdorur kodin e SlotBuddy në çfarëdo mënyre, ju po pranoni kushtet e përshkruara në URL-në e mëposhtme:';
...
$lang['ea_update_success'] = 'SlotBuddy u përditësua me sukses.';
...
$lang['api_token_hint'] = 'Vendosni një token sekret për të aktivizuar autentikimin me bazë token të API-së së SlotBuddy.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API ju lejon të ndërveproni me të gjitha të dhënat e SlotBuddy nëpërmjet protokollit HTTP dhe pikave të disponueshme të API-së dhe të krijoni integrimet tuaja.';
...
$lang['connect'] = 'Lidhu';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Ky integrim ju lejon të lidheni me një server ekzistues LDAP dhe të importoni automatikisht përdoruesit në SlotBuddy dhe t\'i lejoni ata të identifikohen me fjalëkalimin e tyre të drejtorisë (emri i përdoruesit duhet të përputhet).';
$lang['host'] = 'Hosti';
$lang['port'] = 'Porti';
