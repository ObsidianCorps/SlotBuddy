...
$lang['about_app'] = 'درباره SlotBuddy';
...
$lang['about_app_info'] = 'SlotBuddy یک نرم افزار تحت وب با قابلیت سفارشی سازی بسیار بالاست که به مشتریان شما امکان می دهد از طریق وب قرار ملاقات با شما را رزرو کنند. علاوه بر این ، توانایی همگام سازی داده های شما با Google Calendar را فراهم می کند ، بنابراین می توانید از آنها در سایر سرویس ها استفاده کنید.';
$lang['current_version'] = 'نسخه فعلی';
$lang['support'] = 'پشتیبانی';
$lang['about_app_support'] = 'اگر هنگام استفاده از SlotBuddy با مشکلی روبرو شدید می توانید در گروه رسمی Google برای یافتن پاسخ جستجو کنید. همچنین برای کمک به پیشرفت در این زمینه ممکن است لازم باشد یک Issue جدید در صفحه Google Code ایجاد کنید.';
...
$lang['about_app_license'] = 'SlotBuddy تحت مجوز GPLv3 منتشر شده است. با استفاده از کد این نرم افزار به هر شکل، شما با قوانین موجود در لینک زیر موافقت می کنید ';
...
$lang['ea_update_success'] = 'SlotBuddy با موفقیت به روز رسانی شد';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API به شما امکان می‌دهد تا با تمام داده‌های SlotBuddy از طریق پروتکل HTTP و نقاط پایانی API موجود تعامل کنید و ادغام‌های خود را ایجاد کنید.';
...
$lang['connect'] = 'اتصال';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'این ادغام به شما امکان می‌دهد به یک سرور LDAP موجود متصل شوید و به‌طور خودکار کاربران را به SlotBuddy وارد کنید و به آن‌ها اجازه دهید با رمز عبور دایرکتوری خود SSO کنند (نام کاربری باید مطابقت داشته باشد).';
$lang['host'] = 'میزبان';
$lang['port'] = 'پورت';
