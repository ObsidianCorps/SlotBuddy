...
$lang['about_app_info'] = 'SlotBuddy ir ļoti pielāgojama tīmekļa lietojumprogramma, kas ļauj jūsu klientiem rezervēt tikšanās ar jums, izmantojot tīmekli. Turklāt tā nodrošina iespēju sinhronizēt datus ar Google kalendāru, lai jūs tos varētu izmantot ar citiem pakalpojumiem.';
$lang['current_version'] = 'Pašreizējā versija';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'Ja, izmantojot SlotBuddy, jums rodas problēmas, varat meklēt atbildes oficiālajā Google grupā. Iespējams, ka jums būs nepieciešams arī izveidot jaunu jautājumu Google Code lapā, lai palīdzētu virzīt izstrādi.';
...
$lang['about_app_license'] = 'SlotBuddy ir licencēta ar GPLv3 licenci. Jebkurā veidā izmantojot SlotBuddy kodu, jūs piekrītat noteikumiem, kas aprakstīti šajā url:';
...
$lang['ea_update_success'] = 'SlotBuddy ir veiksmīgi atjaunināts.';
...
$lang['api_token_hint'] = 'Iestatiet slepeno žetonu, lai iespējotu uz žetonu balstītu autentifikāciju SlotBuddy API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API ļauj jums mijiedarboties ar visiem SlotBuddy datiem, izmantojot HTTP protokolu un pieejamos API galapunktus, kā arī izveidot savu integrāciju.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Šī integrācija ļauj izveidot savienojumu ar esošo LDAP serveri un automātiski importēt lietotājus programmā SlotBuddy, kā arī ļaut viņiem veikt SSO ar direktorija paroli (lietotājvārdam jābūt vienādam).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
