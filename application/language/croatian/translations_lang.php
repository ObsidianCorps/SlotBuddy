...
$lang['about_app_info'] = 'SlotBuddy je visoko prilagodljiva web aplikacija koja omogućuje vašim klijentima da rezerviraju sastanke s vama putem weba. Osim toga, omogućuje sinkronizaciju vaših podataka s Google kalendarom, tako da ih možete koristiti s drugim uslugama.';
$lang['current_version'] = 'Trenutačna verzija';
$lang['support'] = 'Podrška';
$lang['about_app_support'] = 'Ako naiđete na probleme prilikom korištenja SlotBuddy, možete pretraživati službenu Google grupu za odgovore. Možda ćete također trebati stvoriti novi problem na stranici Google Code kako biste pomogli napretku razvoja.';
...
$lang['about_app_license'] = 'SlotBuddy je licenciran pod GPLv3 licencom. Korištenjem koda SlotBuddy na bilo koji način pristajete na uvjete opisane na sljedećem URL-u:';
...
$lang['ea_update_success'] = 'SlotBuddy je uspješno ažuriran.';
...
$lang['api_token_hint'] = 'Postavite tajni token kako biste omogućili autentifikaciju temeljenu na tokenima za SlotBuddy API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API vam omogućuje interakciju sa svim podacima SlotBuddy putem HTTP protokola i dostupnih krajnjih točaka API-ja te stvaranje vlastitih integracija.';
...
$lang['connect'] = 'Poveži';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Ova integracija omogućuje vam povezivanje s postojećim LDAP poslužiteljem i automatsko uvođenje korisnika u SlotBuddy i omogućuje im SSO s njihovom lozinkom iz imenika (korisničko ime mora odgovarati).';
