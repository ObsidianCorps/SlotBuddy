...
$lang['about_app_info'] = 'SlotBuddy je vysoko prispôsobiteľná webová aplikácia, ktorá umožňuje svojim zákazníkom, aby si rezervácie u Vás online prostredníctvom webu. Navyše poskytuje možnosť synchronizovať vaše dáta s Google Calendárom, ktorý využíva množstvo ľudí, takže ich môžete použiť aj s inými službami.';
$lang['current_version'] = 'Aktuálna verzia';
$lang['support'] = 'Podpora';
$lang['about_app_support'] = 'Ak narazíte na nejaké problémy pri používaní SlotBuddy môžete vyhľadať oficiálnu pomoc u poskytovateľa služby.';
...
$lang['ea_update_success'] = 'SlotBuddy bolo úspešne aktualizované.';
...
$lang['api_token_hint'] = 'Nastavte tajný token, aby ste povolili autentifikáciu na základe tokenov rozhrania SlotBuddy API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API umožňuje interakciu so všetkými údajmi SlotBuddy cez protokol HTTP a dostupné koncové body API a vytváranie vlastných integrácií.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Táto integrácia vám umožňuje pripojiť sa k existujúcemu LDAP serveru a automaticky importovať používateľov do SlotBuddy a umožniť im SSO s ich adresárskym heslom (užívateľské meno musí súhlasiť).';
$lang['host'] = 'Hostiteľ';
$lang['port'] = 'Port';
