...
$lang['about_app'] = 'Despre SlotBuddy';
...
$lang['about_app_info'] = 'SlotBuddy este o aplicatie web usor personalizabila care permite clientilor sa programeze întâlniri cu dumneavoastra de pe internet. Mai mult, are abilitatea de a sincroniza datele dumneavoastra cu Calendarul Google pentru a-l putea folosi împreuna cu alte servicii.';
$lang['current_version'] = 'Versiunea Curenta';
$lang['support'] = 'Suport';
$lang['about_app_support'] = 'Daca întâmpinati orice problema utilizând SlotBuddy puteti cauta grupul oficial Google pentru raspunsuri. Deasemenea va trebui sa creati o noua întrebare acolo pe pagina Google Code pentru a ajuta la dezvoltarea aplicatiei.';
...
$lang['about_app_license'] = 'SlotBuddy este sub licenta GPLv3. folosind codul SlotBuddy în orice fel aduce cu sine acceptarea conditiilor descrise in urmatorul url:';
...
$lang['ea_update_success'] = 'SlotBuddy a fost actualizat.';
...
$lang['api_token_hint'] = 'Setați un token secret pentru a activa autentificarea bazată pe token a API-ului SlotBuddy.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API vă permite să interacționați cu toate datele SlotBuddy prin protocolul HTTP și punctele de acces API disponibile și să creați propriile integrări.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Această integrare vă permite să vă conectați la un server LDAP existent și să importați automat utilizatorii în SlotBuddy, permițându-le să se autentifice cu parola din director (numele de utilizator trebuie să se potrivească).';
$lang['host'] = 'Gazdă';
$lang['port'] = 'Port';
