...
$lang['api_token_hint'] = '设置一个秘密令牌，以启用基于令牌的 SlotBuddy API 认证。';
$lang['timezone'] = '时区';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API 使您能够通过 HTTP 协议和可用的 API 端点与所有 SlotBuddy 数据进行交互，并创建您自己的集成。';
...
$lang['connect'] = '连接';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = '此集成允许您连接到现有的 LDAP 服务器，并自动将用户导入 SlotBuddy，并允许他们使用目录密码进行单点登录（用户名必须匹配）。';
$lang['host'] = '主机';
$lang['port'] = '端口';
$lang['user_dn'] = '用户 DN';
$lang['base_dn'] = '基础 DN';
