...
$lang['about_app_info'] = 'SlotBuddy هو تطبيق ويب قابل للتخصيص بدرجة كبيرة ويسمح لعملائك بحجز المواعيد معك عبر الويب. علاوة على ذلك، فهو يوفر القدرة على مزامنة بياناتك مع تقويم Google حتى تتمكن من استخدامها مع الخدمات الأخرى.';
$lang['current_version'] = 'النسخة الحالية';
$lang['support'] = 'الدعم';
$lang['about_app_support'] = 'إذا واجهت أي مشاكل عند استخدام SlotBuddy، يمكنك البحث في مجموعة Google الرسمية للحصول على إجابات. قد تحتاج أيضًا إلى إنشاء مشكلة جديدة في صفحة Google Code للمساعدة في تقدم عملية التطوير.';
...
$lang['license'] = 'الرخصة';
$lang['about_app_license'] = 'SlotBuddy مرخص بموجب ترخيص GPLv3. باستخدامك لرمز SlotBuddy بأي شكل من الأشكال فإنك توافق على الشروط الموضحة في عنوان URL التالي';
...
$lang['api_token_hint'] = 'قم بتعيين رمز مميز سري لتمكين المصادقة المستندة إلى الرمز المميز لـ SlotBuddy API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'تُمكِّنك واجهة برمجة التطبيقات من التفاعل مع جميع بيانات SlotBuddy عبر بروتوكول HTTP ونقاط نهاية واجهة برمجة التطبيقات المتاحة وإنشاء عمليات التكامل الخاصة بك.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'يمكّنك هذا التكامل من الاتصال بخادم LDAP موجود واستيراد المستخدمين تلقائيًا إلى SlotBuddy والسماح لهم بإدخال كلمة مرور الدليل الخاصة بهم (يجب أن يتطابق اسم المستخدم)';
$lang['host'] = 'المضيف';
$lang['port'] = 'الميناء';
