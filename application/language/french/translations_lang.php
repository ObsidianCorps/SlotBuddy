...
$lang['about_app'] = 'Au sujet d’SlotBuddy';
...
$lang['about_app_info'] = 'SlotBuddy est une application Web hautement personnalisable qui permet à vos clients de prendre rendez-vous avec vous via le web. En outre, elle offre la possibilité de synchroniser vos données avec un calendrier Google afin que vous puissiez les utiliser avec d’autres services. SlotBuddy est un projet open source et vous pouvez le télécharger et l’installer même pour un usage commercial. SlotBuddy fonctionnera sans problème avec votre site web existant car il peut être installé dans un dossier spécifique du serveur et bien sûr, les deux sites peuvent partager la même base de données.';
...
$lang['about_app_license'] = 'SlotBuddy est fourni sous licence GPLv3. En utilisant le code d’SlotBuddy, quelqu’en soit l’usage, vous êtes tenu d’accepter les termes décrits dans l’URL suivante :';
...
$lang['ea_update_success'] = 'SlotBuddy à été mis à jour avec succès.';
...
$lang['api_token_hint'] = 'Définissez un jeton secret afin d’activer l’authentification basée sur le jeton de l’API SlotBuddy. ';
...
$lang['api'] = 'API';
$lang['api_info'] = 'L’API vous permet d’interagir avec toutes les données de SlotBuddy via le protocole HTTP et les points de terminaison API disponibles et créer vos propres intégrations.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Cette intégration vous permet de vous connecter à un serveur LDAP existant et d\'importer automatiquement les utilisateurs dans SlotBuddy, tout en leur permettant de se connecter via leur mot de passe de répertoire (le nom d\'utilisateur doit correspondre).';
$lang['host'] = 'Hôte';
$lang['port'] = 'Port';
