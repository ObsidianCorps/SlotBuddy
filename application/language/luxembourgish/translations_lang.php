...
$lang['about_app'] = 'Iwwert SlotBuddy';
...
$lang['about_app_info'] = 'SlotBuddy ass eng extrem upassungsfäeg Internet-Applikatioun déi et äre Clienten erméiglecht, een Termäin bei Iech iwwert Internet ze huelen. Doriwwer eraus gëtt en Iech d\'Méiglechkeet Är Donnéeën mam Google Kalenner ze synchroniséieren, sou dass Der des mat anere Programmer notze kënnt.';
$lang['current_version'] = 'Aktuell Versioun';
$lang['support'] = 'Ënnerstëtzung';
$lang['about_app_support'] = 'Falls Dir iergendeen Problem beim Benotze vun SlotBuddy hätt, kënnt der déi offiziell Google Grupp no Léisungen duerchsichen. Dir kënnt och een neit Thema am Google Code ufänke fir bei der Sich no Léisungen ze hëllefen. ';
...
$lang['about_app_license'] = 'Easy!Appointment ass ënnert der GPLv3-Lizenz lizenséiert. Duerch d\'Benotze vum Code vun SlotBuddy op iergendeng Aart a Weis stëmmt Der den Lizenzbedingungen, wéi se ënnert folgender URL opgefouert sinn, zou:';
...
$lang['ea_update_success'] = 'SlotBuddy gouf erfollegräich aktualiséiert.';
...
$lang['api_token_hint'] = 'Setzt e geheimen Token fir déi token-baséiert Authentifikatioun vun der SlotBuddy API z\'erméiglechen.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API erméiglecht Iech, mat allen Daten vun SlotBuddy via den HTTP Protokoll an déi verfügbar API Endpunkten ze interagéieren an Är eege Integratiounen ze schafen.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Dës Integratioun erméiglecht Iech eng Verbindung zu engem existente LDAP Server opzebauen an automatesch Benotzer an SlotBuddy z\'importéieren an hinnen Single Sign-On (SSO) mat hirem Verzechnispasswuert (Benotzernumm muss passen) z\'erméiglechen.';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
