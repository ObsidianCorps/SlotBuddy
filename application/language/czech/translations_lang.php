...
$lang['about_app'] = 'O aplikaci SlotBuddy';
...
$lang['about_app_info'] = 'SlotBuddy je vysoce přizpůsobitelná webová aplikace, která vašim zákazníkům umožňuje rezervovat si s vámi schůzky prostřednictvím webu. Navíc poskytuje možnost synchronizovat vaše data s Kalendářem Google, takže je můžete využívat v rámci dalších služeb.';
$lang['current_version'] = 'Aktuální verze';
$lang['support'] = 'Podpora';
$lang['about_app_support'] = 'Pokud při používání SlotBuddy narazíte na jakékoli problémy, můžete odpovědi hledat v oficiální skupině Google. Také můžete založit nový incident na stránce Google Code za účelem podpory dalšího vývoje.';
...
$lang['about_app_license'] = 'SlotBuddy je licencováno pod licencí GPLv3. Používáním kódu SlotBuddy v jakékoli formě souhlasíte s podmínkami popsanými v dokumentu na následující adrese:';
...
$lang['ea_update_success'] = 'Aplikace SlotBuddy byla úspěšně aktualizována.';
...
$lang['api_token_hint'] = 'Nastavte bezpečnostní token, abyste povolili autentizaci tokenem v API SlotBuddy.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API umožňuje komunikovat s daty v SlotBuddy prostřednictvím HTTP protokolu a dostupných API endpointů a vytvářet vaše vlastní integrace.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Tato integrace umožňuje připojovat se k existujícímu LDAP serveru, automaticky importovat uživatele do SlotBuddy a poskytuje možnost přihlašovat se přes SSO pomocí jednotného hesla (uživatelské jméno musí odpovídat).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
