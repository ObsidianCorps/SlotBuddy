...
$lang['about_app_info'] = 'SlotBuddy är ett system som gör det möjligt för dina kunder att, via internet, boka tid för tjänster hos er. Bokningarna kan synkroniseras med dina leverantörers Google-kalendrar så att de bli tillgängliga även för andra tjänster.';
$lang['current_version'] = 'Nuvarande version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'Om du stöter på problem när du använder SlotBuddy kan du söka i den officiella Google-gruppen för support. Du kan även underlätta för utvecklarna genom att registrera ett ärende på GitHub-sidan.';
...
$lang['license'] = 'Licens';
$lang['about_app_license'] = 'SlotBuddy använder GPLv3 licensen. Genom att använda koden till SlotBuddy på något sätt accepterar du villkoren i följande url.';
...
$lang['ea_update_success'] = 'SlotBuddy är uppdaterad.';
...
$lang['api_token_hint'] = 'Ställ in en hemlig token för att aktivera tokenbaserad autentisering av SlotBuddy API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API gör att du kan interagera med all SlotBuddy-data via HTTP-protokollet och de tillgängliga API-slutpunkterna samt skapa egna integrationer.';
...
$lang['connect'] = 'Anslut';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Denna integration gör att du kan ansluta till en befintlig LDAP-server och automatiskt importera användare till SlotBuddy och låta dem använda SSO med sitt kataloglösenord (användarnamn måste matcha).';
$lang['host'] = 'Värd';
$lang['port'] = 'Port';
