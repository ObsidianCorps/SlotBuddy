...
$lang['about_app_info'] = 'SlotBuddy egy könnyen testreszabható webes alkalmazás mely lehetővé teszi, hogy ügyfelek weben keresztül időpontokat foglalhassanak. Ezen felül lehetővé teszi, hogy szinkronizáljuk a foglalások adatait a Google naptárunkkal, így más szolgáltatásokkal is használható.';
$lang['current_version'] = 'Jelenlegi verzió';
$lang['support'] = 'Támogatás';
$lang['about_app_support'] = 'Amennyiben problémákba ütközöl az SlotBuddy használata közben, úgy a hivatalos Google Group-ban tudsz válaszokat keresni. Előfordulhat, hogy egy új lapot kell nyitnod a Google Code-on, hogy segítsd a további fejlesztést.';
...
$lang['about_app_license'] = 'SlotBuddy a GPLv3 licensz alatt áll. Az SlotBuddy forráskódját bármilyen módon használva beleegyezel az alábbi linken található felhasználási feltételekbe:';
...
$lang['api_token_hint'] = 'Állítson be egy titkos tokent az SlotBuddy API token alapú hitelesítésének engedélyezéséhez.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'Az API lehetővé teszi, hogy HTTP protokollon keresztül és az elérhető API végpontokon keresztül kapcsolatba lépjen az SlotBuddy összes adatával és saját integrációkat hozzon létre.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Ez az integráció lehetővé teszi egy meglévő LDAP szerverhez való csatlakozást és automatikus felhasználó importálást az SlotBuddy rendszerbe, valamint a felhasználók SSO-t a könyvtári jelszavukkal (a felhasználónévnek egyeznie kell).';
$lang['host'] = 'Hoszt';
$lang['port'] = 'Port';
