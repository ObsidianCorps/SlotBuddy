...
$lang['about_app'] = 'About SlotBuddy';
...
$lang['about_app_info'] = 'SlotBuddy is a highly customizable web application that allows your customers to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using SlotBuddy you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'SlotBuddy is licensed under the GPLv3 license. By using the code of SlotBuddy in any way you are agreeing to the terms described in the following url:';
...
$lang['ea_update_success'] = 'SlotBuddy has been successfully updated.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the SlotBuddy API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API enable you to interact with all the SlotBuddy data via the HTTP protocol and the available API endpoints and create your own integrations.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'This integration enables you to connect to an existing LDAP server and automatically import users into SlotBuddy and let them SSO with their directory password (username must match).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
