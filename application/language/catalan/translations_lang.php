...
$lang['about_app'] = 'Quant a SlotBuddy';
...
$lang['about_app_info'] = 'SlotBuddy és una aplicació web molt ajustable que permet als vostres clients reservar cites amb vosaltres a través del web. A més, us permet sincronitzar amb Google Calendar de manera que ho podeu usar amb altres serveis.';
$lang['current_version'] = 'Versió actual';
$lang['support'] = 'Suport';
$lang['about_app_support'] = 'Si trobeu qualsevol problema fent servir SlotBuddy, podeu consultar el Google Group per a trobar respostes. També podeu crear noves incidències a la pàgina de Google Code per ajudar al desenvolupament.';
...
$lang['about_app_license'] = 'SlotBuddy es distribueix amb una llicència GPLv3. Usant el codi d\'SlotBuddy de qualsevol manera, esteu consentint els termes descrits en la següent URL:';
...
$lang['ea_update_success'] = 'SlotBuddy s\'ha actualitzat correctament.';
...
$lang['api_token_hint'] = 'Establiu un token secret per permetre l\'autenticació basada en tokens de l\'API d\'SlotBuddy.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'L\'API us permet interaccionar amb totes les dades SlotBuddy via el protocol HTTP i els API endpoint disponibles i crear les vostres pròpies integracions.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Aquesta integració us permet connectar amb un servidor LDAP i automàticament importar els usuaris a SlotBuddy. A més, permet que els usuaris facin SSO amb la contrasenya LDAP (el nom d\'usuari ha de coincidir).';
$lang['host'] = 'Servidor';
$lang['port'] = 'Port';
