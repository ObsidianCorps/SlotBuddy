...
$lang['about_app'] = 'Sobre o SlotBuddy';
...
$lang['about_app_support'] = 'Se  encontrar algum problema ao usar o SlotBuddy pode procurar o Grupo oficial do Google para obter respostas. Se precisar, pode iniciar um novo tópico na página do Google Code, a fim de ajudar o progresso do desenvolvimento.';
...
$lang['about_app_license'] = 'SlotBuddy está licenciado sob a licença GPLv3. Ao utilizar o código de SlotBuddy de qualquer forma concorda com os termos descritos na seguinte url:';
...
$lang['ea_update_success'] = 'SlotBuddy foi atualizado com sucesso.';
...
$lang['api_token_hint'] = 'Defina um token secreto para habilitar a autenticação baseada em token da API SlotBuddy.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'A API permite interagir com todos os dados do SlotBuddy via protocolo HTTP e os endpoints da API disponíveis e criar suas próprias integrações.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Esta integração permite conectar-se a um servidor LDAP existente e importar automaticamente usuários para o SlotBuddy, permitindo que eles façam SSO com sua senha do diretório (o nome de usuário deve corresponder).';
$lang['host'] = 'Host';
$lang['port'] = 'Porta';
