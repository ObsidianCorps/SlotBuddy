...
$lang['about_app_support'] = 'Se  encontrar algum problema ao usar o SlotBuddy pode procurar o Grupo oficial do Google para obter respostas. Pode precisar de criar uma nova questão na página do Google Code, a fim de ajudar o progresso do desenvolvimento.';
...
$lang['api_token_hint'] = 'Defina um token secreto para habilitar a autenticação baseada em token da API do SlotBuddy.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API permite interagir com todos os dados do SlotBuddy via protocolo HTTP e os endpoints de API disponíveis e criar suas próprias integrações.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Esta integração permite conectar a um servidor LDAP existente e importar automaticamente usuários para o SlotBuddy e permitir que eles façam SSO com sua senha de diretório (o nome de usuário deve corresponder).';
$lang['host'] = 'Host';
$lang['port'] = 'Porta';
