...
$lang['about_app_info'] = 'SlotBuddy 是一個高度可客製化的網頁應用程式，允許您的顧客透過網路與您預約。此外，它還提供與 Google 日曆同步的功能，讓您可以與其他服務一起使用。';
$lang['current_version'] = '目前版本';
$lang['support'] = '支援';
$lang['about_app_support'] = '如果您在使用 SlotBuddy 時遇到任何問題，您可以在官方 Google 群組中搜尋答案。您可能還需要在 Google Code 頁面上建立一個新問題，以幫助開發進展。';
$lang['official_website'] = '官方網站';
$lang['google_plus_community'] = 'Google+ 社群';
$lang['support_group'] = '支援群組';
$lang['project_issues'] = '專案問題';
$lang['license'] = '授權';
$lang['about_app_license'] = 'SlotBuddy 授權於 GPLv3 許可證下。以任何方式使用 SlotBuddy 的程式碼，即表示您同意以下網址中描述的條款：';
...
$lang['ea_update_success'] = 'SlotBuddy 已成功更新。';
...
$lang['api_token_hint'] = '設定一個金鑰以啟用 SlotBuddy API 的權杖式驗證。';
$lang['timezone'] = '時區';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API 允許您透過 HTTP 協議和可用的 API 端點與所有 SlotBuddy 資料進行互動，並建立您自己的整合。';
...
$lang['connect'] = '連線';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = '此整合允許您連線到現有的 LDAP 伺服器，並自動將使用者匯入 SlotBuddy，並讓他們使用目錄密碼進行單一登入（使用者名稱必須相符）。';
$lang['host'] = '主機';
$lang['port'] = '連接埠';
$lang['user_dn'] = '使用者 DN';
$lang['base_dn'] = '基礎 DN';
