...
$lang['about_app'] = 'SlotBuddy Hakkında';
...
$lang['about_app_info'] = 'SlotBuddy yüksek ölçüde özelleştirilebilen, müşterilerinizin web üzerinden randevu almasını sağlayan bir uygulamadır. Ayrıca, bilgilerinizi Google Takvim ile eşitleyerek diğer uygulamalarla da entegre olmasını sağlar. ';
$lang['current_version'] = 'Mevcut Versiyon';
$lang['support'] = 'Destek';
$lang['about_app_support'] = 'SlotBuddy kullanımı sırasında sorun yaşamanız halinde resmi Google Group üzerinde arama yapabilirsiniz. Ayrıca geliştirmeye destek olmak için Google Code sayfasında yeni sorun girişi de yapabilirsiniz.';
...
$lang['license'] = 'Lisans';
$lang['about_app_license'] = 'SlotBuddy GPLv3 kapsamında lisanslıdır. Bu yazılımı herhangi bir biçimde kullanarak aşağıdaki adreste belirtilen koşulları kabul etmiş olursunuz:';
...
$lang['ea_update_success'] = 'SlotBuddy başarı ile güncellendi.';
...
$lang['api_token_hint'] = 'SlotBuddy Api sinin belirteç tabanlı kimlik doğrulamasını etkinleştirmek için gizli bir belirteç ayarlayın.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API’ler, HTTP protokolü ve mevcut API uç noktaları aracılığıyla tüm SlotBuddy verileriyle etkileşime geçmenizi sağlar ve kendi entegrasyonlarınızı oluşturmanıza olanak tanır.';
...
$lang['connect'] = 'Bağlan';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Bu entegrasyon, mevcut bir LDAP sunucusuna bağlanmanızı ve kullanıcıları SlotBuddy’a otomatik olarak aktarmanızı sağlar ve onları dizin parolalarıyla SSO yapmalarına izin verir (kullanıcı adı eşleşmelidir).';
