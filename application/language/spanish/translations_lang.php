...
$lang['about_app'] = 'Acerca de SlotBuddy';
...
$lang['about_app_info'] = 'SlotBuddy es un aplicativo web completamente personalizable que le permitirá a sus clientes agendar citas con Usted a través internet. Además, le permitirá sincronizar sus datos con Google Calendar, para poder utilizarlos con otros servicios.';
$lang['current_version'] = 'Versión actual';
$lang['support'] = 'Soporte';
$lang['about_app_support'] = 'El grupo oficial de respuestas de Google Groups se encuentra a su disposición, en caso de que encuentre algún inconveniente con SlotBuddy.  También podrá informar incidentes en la página de Google Code y así ayudar en el proceso de desarrollo de la herramienta.';
...
$lang['about_app_license'] = 'SlotBuddy se encuentra bajo licencia GPLv3. Todo tipo de uso del código de SlotBuddy presume la aceptación de los términos desciptos en la siguiente dirección web:';
...
$lang['ea_update_success'] = 'SlotBuddy ha sido actualizado exitosamente';
...
$lang['api_token_hint'] = 'Defina un token secreto para habilitar la autentificación por token mediante la API de SlotBuddy.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'La API permite interactuar con todos los datos de SlotBuddy mediante el protocolo HTTP, así como con los API Endpoints y crear tus propias integraciones.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Esta integración le permite conectar con un servidor LDAP existente e importar automáticamente usuarios a SlotBuddy y permitirles el SSO con su contraseña de directorio (el nombre de usuario debe coincidir).';
$lang['host'] = 'Host';
$lang['port'] = 'Puerto';
