...
**SlotBuddy** is a highly customizable web application that allows customers to book appointments with you 
...
SlotBuddy will run smoothly with your existing website as it can be installed in a single folder of the 
...
* Copy the "slotbuddy" source folder on your server.
* Make sure that the "storage" directory is writable.
* Rename the "config-sample.php" file to "config.php" and update its contents based on your environment.
* Open the browser on the SlotBuddy URL and follow the installation guide.

That's it! You can now use SlotBuddy at your will.
